const highlightColor = "rgb(252, 56, 69)";

//source for getting highlighter icon and red highlight (not currently using, but can implement in future as an add-on functionality)
//: https://medium.com/@mariusbongarts/how-to-build-the-medium-text-highlighter-as-a-chrome-extension-with-web-components-b3feccddcd01
const template = `
